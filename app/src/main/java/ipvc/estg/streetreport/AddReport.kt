...
class AddReport : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button.setOnClickListener {
            ...
            val descEnviar: RequestBody = RequestBody.create(MediaType.parse("multipart/form-data"), desc)
            ...
            val call = request.createReport(descEnviar, latEnviar, longEnviar, userEnviar, tipoEnviar, image)
            ...
            call.enqueue(object : Callback<OutputPostReport> {
                override fun onResponse(call: Call<OutputPostReport>, response: Response<OutputPostReport>) {
                    ...
                    if (response.isSuccessful) {
                        Toast.makeText(this@AddReport, getString(R.string.reportadd), Toast.LENGTH_SHORT).show()
                        ...
                        Toast.makeText(this@AddReport, response.code(), Toast.LENGTH_SHORT).show()
                    }
                }
